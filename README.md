...
"Serial Port tab" Baound RAte: 9600, Bata bit: 8, Stop bit: 1, Parity: 0, Buffer Size: 512, Gap Time: 50, Cli: Serial String, Srial String: +++, Waiting Toime: 15, Flow control: Disable, Protocol: None,

Comumunication Settings: Protocol: UDP Client, Serwer: your IP LAN Nod-Red, Server POrt: 2005, Local Port: 2005, BUffer Size: 512, Keep Alive: 60, Timeout: 0, Connect Mode: Always, Register Mode: Disable, Security: Disable, Route: UART,
